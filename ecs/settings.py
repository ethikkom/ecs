...
MANAGERS = ADMINS = ()
# eg. this could be MANAGERS = ADMINS = (('Your Username', 'your.email@example.org'),)
...
MS_CLIENT = {"server": "http://localhost:8000", "bucket": "/mediaserver/",
    ...
    "key_id": "changeme", "key_secret": "changeme" }
...
EMAIL_WHITELIST = ['alice@example.org', 'bob@example.org', 'unittest@example.org', 'new.user@example.org', ]
# FIXME: Agenda, Billing is send to whitelist instead of invited people (FMD2)
AGENDA_RECIPIENT_LIST = ('root@example.org',)
...
FEEDBACK_CONFIG = {'create_trac_tickets': True, 'store_in_db': False,
    'RPC_CONFIG': {'username': 'username', 'password': 'password', 'proto': 'https', 'host': 'hostname.org', 'urlpath': '/whereever/projectname'},
    'milestone': 'Milestone 9', 'component': 'feedback',
